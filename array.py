    ...
    for n in range(3):
        for i in range(4,24):
            for j in range(4,24):
                ...
                cv2.imwrite(os.path.join(p,'7_3_%i_R_%i.jpg'%(k,count)),a2)
                count = count+1
    ...
    for n in range(3):
        for i in range(4,24):
            for j in range(4,24):
                ...
                cv2.imwrite(os.path.join(p,'7_3_%i_B_%i.jpg'%(k,count)),a2)
                count = count+1
    ...
    for n in range(7):
        for i in range(8,20):
            for j in range(8,20):
                ...
                cv2.imwrite(os.path.join(p,'15_3_%i_B_%i.jpg'%(k,count)),a2)
                count = count+1
    ...
    for n in range(7):
        for i in range(8,20):
            for j in range(8,20):
                ...
                cv2.imwrite(os.path.join(p,'15_3_%i_R_%i.jpg'%(k,count)),a2)
                count = count+1
    ...
    for n in range(7):
        for i in range(8,20):
            for j in range(8,20):
                ...
                cv2.imwrite(os.path.join(p,'15_1_%i_R_%i.jpg'%(k,count)),a2)
                count = count+1
    ...
    for n in range(7):
        for i in range(8,20):
            for j in range(8,20):
                ...
                cv2.imwrite(os.path.join(p,'15_1_%i_B_%i.jpg'%(k,count)),a2)
                count = count+1
    ...
    for n in range(3):
        for i in range(4,24):
            for j in range(4,24):
                ...
                cv2.imwrite(os.path.join(p,'7_1_%i_R_%i.jpg'%(k,count)),a2)
                count = count+1
    ...
    for n in range(3):
        for i in range(4,24):
            for j in range(4,24):
                ...
                cv2.imwrite(os.path.join(p,'7_1_%i_B_%i.jpg'%(k,count)),a2)
                count = count+1